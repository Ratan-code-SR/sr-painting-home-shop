                ...
                <div className="container mx-auto space-y-12">
                    <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
                        <img
                            ...
                            data-aos-easing="ease-in-out"
                            src="https://i.ibb.co/Zxw5Fw6/images-11.jpg" alt="" className="h-80 dark:bg-gray-500 aspect-video" />
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
                        <img
                            ...
                            src="https://i.ibb.co/DWc0r6w/oil6.jpg" alt="" className="h-80 dark:bg-gray-500 aspect-video" />
                        <div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-50"
                          data-duration-aos="1000"
                          data-aos="fade-right"
                          data-aos-delay="100"
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
                        <img
                            ...
                            data-aos-duration="1000"
                            data-aos-easing="ease-in-out"
                            src="https://i.ibb.co/tP8K97M/images-24.jpg" alt="" className="h-80 dark:bg-gray-500 aspect-video" />
                        <div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-50"
                          data-duration-aos="1000"
                          data-aos="fade-left"
                          data-aos-delay="100"
